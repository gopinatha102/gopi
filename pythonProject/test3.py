class Bank:
    ...
    def dd_deposit(self,dd_no):
        ...
        self.balance += amt
        print("*" * 30)
        print("DD No ", self.dd_no)
        print("After DD Deposit Account Details")
        obj.bank_details()
        obj.display_Account_Details()
    ...
    def withdraw(self):
        ...
        print("After Withdraw Bank Account Details ")
        obj.bank_details()
        obj.display_Account_Details()
    ...
    def check_withdraw(self, check_withdraw_no):
        ...
        self.balance -= amt
        print("*" * 30)
        print("Check No ", self.check_withdraw_no)
        print("After Cheek Deposit Account Details")
        obj.bank_details()
        obj.display_Account_Details()
    ...
    def dd_withdraw(self, dd_withdraw_no):
        amt = float(input("Enter the withdraw amount:"))
        self.withdraw_dd_no = dd_withdraw_no
        self.balance -= amt
        print("*" * 30)
        print("DD No ", self.withdraw_dd_no)
        print("After DD withdraw Account Details")
        obj.bank_details()
        obj.display_Account_Details()
    ...
    def deposit_mode_selection(self):
        ...
        if option == 1:
            ...
            print("After Check Deposit Account Total Balance = ", l[i].balance)
...
print("*"*10,"4------------Continue ","*"*10)
print("*"*10,"5 ---------- Quit the program","*"*10)
while True :
    print("*" * 30)
    ...
    if option == 0:
        ...
        if i == count_no_obj:
            for l2 in l:
                ...
                account_no = int(input("Enter The Account No:"))
                print("*" * 30)
                print("\t", l2.name, "\t", l2.account_no)

                if (l2.name == name) and (l2.account_no == account_no):
                    print("*" * 30)
                    obj.deposit_mode_selection()
                    print("After Deposit Account Total Balance = ", l2.balance)
                else:
        ...
        """
        for l2 in l:
            name = input("Enter Withdraw  Name :")
            account_no = int(input("Enter The Withdraw Account No:"))
            print("*" * 30)
            print("\t", l2.name,"\t", l2.account_no)
            if (l2.name == name) and (l2.account_no == account_no):
                print("*" * 30)
                obj.withdraw_mode_selection()
                print("After Withdraw Total Balance = ", l2.balance)
            else:
                print("Name not matched ")
